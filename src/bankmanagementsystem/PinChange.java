    ...
    public void actionPerformed(ActionEvent ae){
        try{        
            ...
            if(ae.getSource()==b1){
                ...
                Conn c1 = new Conn();
                String q1 = "update bank set pinnumber = '"+rpin+"' where pinnumber = '"+pin+"' AND cardnumber = '"+cardnumber+"'";
                String q2 = "update login set pinnumber = '"+rpin+"' where pinnumber = '"+pin+"' AND cardnumber = '"+cardnumber+"'";
                String q3 = "update signupthree set pinnumber = '"+rpin+"' where pinnumber = '"+pin+"' AND cardnumber = '"+cardnumber+"'";
